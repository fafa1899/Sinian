...
// camera
shared_ptr<PerspectiveCamera> camera = make_shared<PerspectiveCamera>(50.0f, 
...
shared_ptr<Scene> CreateTexturesCombine()
{
	...
	const char* texturePath1 = "D:/Work/learnopengl/LearnOpenGL/resources/textures/container.jpg";
	shared_ptr<Texture2D> texture1 = make_shared<Texture2D>(texturePath1);

	const char* texturePath2 = "D:/Work/learnopengl/LearnOpenGL/resources/textures/awesomeface.png";
	...
	const char* vertexPath = "D:/Work/learnopengl/MyProj/SinianViewer/SinianViewer/textures_combine.vs";
	const char* fragmentPath = "D:/Work/learnopengl/MyProj/SinianViewer/SinianViewer/textures_combine.fs";
	std::shared_ptr<ShaderMaterial> material = make_shared<ShaderMaterial>(vertexPath, fragmentPath, uniforms);
...
shared_ptr<Mesh> CreateCubeMesh()
{
	...
	std::shared_ptr<MeshBasicMaterial> material = make_shared<MeshBasicMaterial>();
	material->MapTexture(texture1);
...
int main()
{
	...
	camera->WorldModelTranform(glm::vec3(0.0f, 0.0f, 3.0f), glm::vec3(glm::radians(0.0f), 
